            ...
            <div className="py-10 px-5 overflow-hidden">
                <div className="flex flex-row justify-center items-center relative text-center pt-12 sm:justify-between md:text-start">
                    <div>
                        ...
                        <h3 className="mb-5 text-3xl sm:mb-16">
                        ...
                        <span className="mr-5">
                            {Math.floor(forecast.forecastday[0].day.mintemp_c)}
                            &deg; /{' '}
                            {Math.floor(forecast.forecastday[0].day.maxtemp_c)}
                            &deg;
                        </span>
                        <span>
                            Average Temperature:{' '}
                            {Math.floor(forecast.forecastday[0].day.avgtemp_c)}
                            &deg;
                        </span>
                    </div>
